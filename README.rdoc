...
:namespace :: Sets the default namespace(s) to use for the form
...
This should be a hash with input type keys, where the values are the hash of
default options to use for the input type. 
