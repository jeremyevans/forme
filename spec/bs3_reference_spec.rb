...
describe "Forme Bootstrap3 (BS3) forms" do
  ...
  it "should create an input[:file] tag with a label when ':id => bar' with an error" do
    @f.input(:file, :label=>"Name", :id=>'bar', :class=>'foo', :error=>'input-file-error').to_s.must_equal '<div class="form-group has-error"><label for="bar">Name</label> <input aria-describedby="bar_error_message" aria-invalid="true" class="foo" id="bar" type="file"/><span class="help-block with-errors" id="bar_error_message">input-file-error</span></div>'
  end
  ...
  it "should create a input[:submit] tag with attributes" do
    @f.input(:submit, :attr=>{:class=>'bar'}).to_s.must_equal '<input class="btn btn-default bar" type="submit"/>'
  end
  ...
  it "should remove form-control class from attributes for input[:checkbox] tag" do
    @f.input(:checkbox, :class=>'form-control').to_s.must_equal '<div class="checkbox"><input type="checkbox"/></div>'
  end
  ...
  it "should create an input[:checkbox] tag with a label when ':id => bar' with an error" do
    @f.input(:checkbox, :label=>"Gold", :id=>'bar', :class=>'foo', :error=>'input-checkbox-error').to_s.must_equal '<div class="has-error"><div class="checkbox"><label for="bar"><input aria-describedby="bar_error_message" aria-invalid="true" class="foo" id="bar" type="checkbox"/> Gold</label></div><span class="help-block with-errors" id="bar_error_message">input-checkbox-error</span></div>'
  end
  ...
  it "should create an input[:radio] tag with a label when ':id => bar' with an error" do
    @f.input(:radio, :label=>"Gold", :id=>'bar', :class=>'foo', :error=>'input-radio-error').to_s.must_equal '<div class="has-error"><div class="radio"><label for="bar"><input aria-describedby="bar_error_message" aria-invalid="true" class="foo" id="bar" type="radio"/> Gold</label></div><span class="help-block with-errors" id="bar_error_message">input-radio-error</span></div>'
  end
